...
class leaderboardCreateEntityScreen extends StatefulWidget {
  const leaderboardCreateEntityScreen({super.key});

  @override
  _leaderboardCreateEntityScreenState createState() =>
      _leaderboardCreateEntityScreenState();
}

class _leaderboardCreateEntityScreenState
    extends State<leaderboardCreateEntityScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "Create LeaderBoard")),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          onsaved: (value) => formData['team'] = value,
                        )
                      ]),
                ),
                const SizedBox(height: 16),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          onsaved: (value) => formData['tournament'] = value,
                        )
                      ]),
                ),
                const SizedBox(height: 16),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          onsaved: (value) => formData['league'] = value,
                        )
                      ]),
                ),
                const SizedBox(height: 16),
