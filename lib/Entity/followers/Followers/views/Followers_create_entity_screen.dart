...
class followersCreateEntityScreen extends StatefulWidget {
  const followersCreateEntityScreen({super.key});

  @override
  _followersCreateEntityScreenState createState() =>
      _followersCreateEntityScreenState();
}

class _followersCreateEntityScreenState
    extends State<followersCreateEntityScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "Create Followers")),
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Text('Failed to create Followers: $e'),
                              actions: [
                                TextButton(
                                  child: const Text('OK'),
                                  onPressed: () {
