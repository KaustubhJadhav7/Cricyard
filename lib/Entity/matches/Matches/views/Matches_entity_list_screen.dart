...
class matches_entity_list_screen extends StatefulWidget {
  static const String routeName = '/entity-list';

  @override
  _matches_entity_list_screenState createState() =>
      _matches_entity_list_screenState();
}
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: " Matches"),
        actions: [
          Switch(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    entity['match_name'] ?? 'No Match Name Available',
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    entity['score'] ?? 'No Score Available',
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                    style: AppStyle.txtGilroyMedium16Bluegray900,
                  ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    entity['result'] ?? 'No Result Available',
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                    style: AppStyle.txtGilroyMedium16Bluegray900,
                  ),
