...
import 'Player_Detail_create_entity_screen.dart';
import 'Player_Detail_update_entity_screen.dart';
...
class player_detail_entity_list_screen extends StatefulWidget {
  static const String routeName = '/entity-list';

  @override
  _player_detail_entity_list_screenState createState() =>
      _player_detail_entity_list_screenState();
}

class _player_detail_entity_list_screenState
    extends State<player_detail_entity_list_screen> {
  ...
  //       });
  //       print('Player_Detail entity is .. $serachEntities');
  //     }
  //   } catch (e) {
  //     showDialog(
  //       context: context,
  ...
  //           content: Text('Failed to fetch Player_Detail: $e'),
  //           actions: [
  //             TextButton(
  //               child: const Text('OK'),
  //               onPressed: () {
  ...
  //         return AlertDialog(
  //           title: const Text('Error'),
  //           content: Text('Failed to fetch Player_Detail data: $e'),
  //           actions: [
  //             TextButton(
  //               child: const Text('OK'),
  //               onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: " Player_Detail"),
        actions: [
          Switch(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => player_detailCreateEntityScreen(),
            ),
          ).then((_) {
            provider.fetchEntities();
          });
  ...
  Widget _buildNormalView(PlayerDetailModel entity) {
                    ...
                    onSelected: (String value) {
                      if (value == 'edit') {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                player_detailUpdateEntityScreen(entity: entity),
                          ),
                        ).then((_) {
                          provider.fetchEntities();
                        });
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    entity.phoneNumber ?? 'No Phone Number Available',
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                    style: AppStyle.txtGilroyMedium16Bluegray900,
                  ),
