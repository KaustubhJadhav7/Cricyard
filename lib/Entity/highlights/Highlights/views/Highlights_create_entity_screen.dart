...
class highlightsCreateEntityScreen extends StatefulWidget {
  ...
  @override
  _highlightsCreateEntityScreenState createState() =>
      _highlightsCreateEntityScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "Create Highlights")),
...
// ValidationProperties
                              ...
                              onsaved: (value) => formData['duration'] = value,
                              margin: getMargin(top: 6))
                        ])),
                SizedBox(height: 16),
                Switch(
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Text('Failed to create Highlights: $e'),
                              actions: [
                                TextButton(
                                  child: const Text('OK'),
                                  onPressed: () {
