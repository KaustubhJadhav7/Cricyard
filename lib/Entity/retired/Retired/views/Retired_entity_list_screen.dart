...
class retired_entity_list_screen extends StatefulWidget {
  static const String routeName = '/entity-list';

  @override
  _retired_entity_list_screenState createState() =>
      _retired_entity_list_screenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: " Retired"),
        actions: [
          Switch(
