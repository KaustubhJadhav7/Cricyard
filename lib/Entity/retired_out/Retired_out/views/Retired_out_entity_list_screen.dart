...
import 'Retired_out_create_entity_screen.dart';
import 'Retired_out_update_entity_screen.dart';
...
class retired_out_entity_list_screen extends StatefulWidget {
  static const String routeName = '/entity-list';

  @override
  _retired_out_entity_list_screenState createState() =>
      _retired_out_entity_list_screenState();
}

class _retired_out_entity_list_screenState
    extends State<retired_out_entity_list_screen> {
  ...
  //       });
  //       print('Retired_out entity is .. $serachEntities');
  //     }
  //   } catch (e) {
  //     showDialog(
  //       context: context,
  ...
  //           content: Text('Failed to fetch Retired_out: $e'),
  //           actions: [
  //             TextButton(
  //               child: const Text('OK'),
  //               onPressed: () {
  ...
  //         return AlertDialog(
  //           title: const Text('Error'),
  //           content: Text('Failed to fetch Retired_out data: $e'),
  //           actions: [
  //             TextButton(
  //               child: const Text('OK'),
  //               onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: " Retired_out"),
        actions: [
          Switch(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => retired_outCreateEntityScreen(),
            ),
          ).then((_) {
            provider.fetchEntities();
          });
  ...
  Widget _buildNormalView(RetiredOutEntity entity) {
                    ...
                    onSelected: (String value) {
                      if (value == 'edit') {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                retired_outUpdateEntityScreen(entity: entity),
                          ),
                        ).then((_) {
                          provider.fetchEntities();
                        });
