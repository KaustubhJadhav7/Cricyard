...
class contact_us_entity_list_screen extends StatefulWidget {
  ...
  @override
  _contact_us_entity_list_screenState createState() =>
      _contact_us_entity_list_screenState();
}

class _contact_us_entity_list_screenState
    extends State<contact_us_entity_list_screen> {
  ...
  Future<void> fetchwithoutpaging() async {
    try {
      ...
      if (token != null) {
        ...
        print('Contact_us entity is .. $serachEntities');
      }
    } catch (e) {
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text('Failed to fetch Contact_us: $e'),
            actions: [
              TextButton(
                child: const Text('OK'),
                onPressed: () {
    ...
    try {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('Error'),
            content: Text('Failed to fetch Contact_us data: $e'),
            actions: [
              TextButton(
                child: const Text('OK'),
                onPressed: () {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: " Contact_us"),
        actions: [
          Switch(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => contact_usCreateEntityScreen(),
            ),
          ).then((_) {
            fetchEntities();
          });
                    ...
                    onSelected: (String value) {
                      if (value == 'edit') {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                contact_usUpdateEntityScreen(entity: entity),
                          ),
                        ).then((_) {
                          fetchEntities();
                        });
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    entity['comment'] ?? 'No Comment Available',
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                    style: AppStyle.txtGilroyMedium16Bluegray900,
                  ),
