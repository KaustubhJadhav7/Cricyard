...
class live_score_updateCreateEntityScreen extends StatefulWidget {
  const live_score_updateCreateEntityScreen({super.key});

  @override
  _live_score_updateCreateEntityScreenState createState() =>
      _live_score_updateCreateEntityScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "Create Live_Score_Update")),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          onsaved: (value) =>
                              formData['live_commentary'] = value,
                        )
                      ]),
                ),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          onsaved: (value) => formData['boundary'] = value,
                        )
                      ]),
                ),
                const SizedBox(height: 16),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          onsaved: (value) => formData['wickets'] = value,
                        )
                      ]),
                ),
                const SizedBox(height: 16),
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Text(
                                  'Failed to create Live_Score_Update: $e'),
                              actions: [
                                TextButton(
                                  child: const Text('OK'),
                                  onPressed: () {
