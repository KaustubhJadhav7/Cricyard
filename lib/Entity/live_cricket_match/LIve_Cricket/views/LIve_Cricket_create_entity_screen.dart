...
class live_cricketCreateEntityScreen extends StatefulWidget {
  const live_cricketCreateEntityScreen({super.key});

  @override
  _live_cricketCreateEntityScreenState createState() =>
      _live_cricketCreateEntityScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "Create LIve_Cricket")),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          onsaved: (value) => formData['overs'] = value,
                        )
                      ]),
                ),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          onsaved: (value) => formData['team_run_rate'] = value,
                        )
                      ]),
                ),
                const SizedBox(height: 16),
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content:
                                  Text('Failed to create LIve_Cricket: $e'),
                              actions: [
                                TextButton(
                                  child: const Text('OK'),
                                  onPressed: () {
