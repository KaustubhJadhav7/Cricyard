...
class live_cricket_entity_list_screen extends StatefulWidget {
  static const String routeName = '/entity-list';

  @override
  _live_cricket_entity_list_screenState createState() =>
      _live_cricket_entity_list_screenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: " LIve_Cricket"),
        actions: [
          Switch(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    entity['team_run_rate'] ?? 'No Team Run rate Available',
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                    style: AppStyle.txtGilroyMedium16Bluegray900,
                  ),
