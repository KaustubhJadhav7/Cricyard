...
import 'Find_Friends_create_entity_screen.dart';
import 'Find_Friends_update_entity_screen.dart';
...
class find_friends_entity_list_screen extends StatefulWidget {
  static const String routeName = '/entity-list';

  @override
  _find_friends_entity_list_screenState createState() =>
      _find_friends_entity_list_screenState();
}

class _find_friends_entity_list_screenState
    extends State<find_friends_entity_list_screen> {
  ...
  Future<void> fetchwithoutpaging() async {
    try {
      ...
      if (token != null) {
        ...
        print('Find_Friends entity is .. $serachEntities');
      }
    } catch (e) {
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text('Failed to fetch Find_Friends: $e'),
            actions: [
              TextButton(
                child: const Text('OK'),
                onPressed: () {
    ...
    try {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('Error'),
            content: Text('Failed to fetch Find_Friends data: $e'),
            actions: [
              TextButton(
                child: const Text('OK'),
                onPressed: () {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: " Find_Friends"),
        actions: [
          Switch(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => find_friendsCreateEntityScreen(),
            ),
          ).then((_) {
            fetchEntities();
          });
                    ...
                    onSelected: (String value) {
                      if (value == 'edit') {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                find_friendsUpdateEntityScreen(entity: entity),
                          ),
                        ).then((_) {
                          fetchEntities();
                        });
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    entity['find_friends'] ?? 'No Find Friends Available',
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
