...
import 'Obstructing_The_Field_create_entity_screen.dart';
import 'Obstructing_The_Field_update_entity_screen.dart';
...
class obstructing_the_field_entity_list_screen extends StatefulWidget {
  static const String routeName = '/entity-list';

  @override
  _obstructing_the_field_entity_list_screenState createState() =>
      _obstructing_the_field_entity_list_screenState();
}

class _obstructing_the_field_entity_list_screenState
    extends State<obstructing_the_field_entity_list_screen> {
  ...
  //       });
  //       print('Obstructing_The_Field entity is .. $serachEntities');
  //     }
  //   } catch (e) {
  //     showDialog(
  //       context: context,
  ...
  //           content: Text('Failed to fetch Obstructing_The_Field: $e'),
  //           actions: [
  //             TextButton(
  //               child: const Text('OK'),
  //               onPressed: () {
  ...
  //         return AlertDialog(
  //           title: const Text('Error'),
  //           content: Text('Failed to fetch Obstructing_The_Field data: $e'),
  //           actions: [
  //             TextButton(
  //               child: const Text('OK'),
  //               onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: " Obstructing_The_Field"),
        actions: [
          Switch(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    ...
                    onPressed: () {
                      provider.startListening(searchController);
                    },
                  ),
                ),
              ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => obstructing_the_fieldCreateEntityScreen(),
            ),
          ).then((_) {
            provider.fetchEntities();
          });
                    ...
                    onSelected: (String value) {
                      if (value == 'edit') {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                obstructing_the_fieldUpdateEntityScreen(
                                    entity: entity),
                          ),
                        ).then((_) {
                          provider.fetchEntities();
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    entity['runs_scored'] ?? 'No Runs scored Available',
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
