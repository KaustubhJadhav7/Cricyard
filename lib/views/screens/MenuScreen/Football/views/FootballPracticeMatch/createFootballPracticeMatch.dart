...
import '../../../../practice_match/practiceView/PracticeMatchScoreScreen.dart';
...
class _CreateFootballPracticeMatchState extends State<CreateFootballPracticeMatch> {
  ...
  void _submitForm(PracticeMatchviewModel model) async {
    ...
    String preferredSport = prefs.getString('preferred_sport') ?? 'Cricket'; // Default to 'Cricket'
    ...
    try {
      Map<String, dynamic> match = await model.createPracticeMatchFootball(formData);
