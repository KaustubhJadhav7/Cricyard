...
class TournamentScoreBoardScreen extends StatefulWidget {
  final int matchId;
  final String team1;
  final String team2;
  const TournamentScoreBoardScreen({super.key,required this.matchId, required this.team1, required this.team2});

  @override
  State<TournamentScoreBoardScreen> createState() => _TournamentScoreBoardScreenState();
}

class _TournamentScoreBoardScreenState extends State<TournamentScoreBoardScreen> with TickerProviderStateMixin {
                        ...
                        children: [
                          pw.Container(
                            ...
                            child: pw.Row(
                              ...
                              children: [
                                pw.Container(width: 100, child: pw.Text('Batsman')),
                                pw.Container(width: 40, child: pw.Text('Runs')),
                                pw.Container(width: 40, child: pw.Text('Balls')),
                          ...
                          for (var player in data['players'].where((p) => p['player_type'] == 'Batsman'))
                            pw.Container(
                              color: PdfColors.grey200,
                              child: pw.Row(
                                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                children: [
                                  pw.Container(width: 100, child: pw.Text(player['player_name'])),
                                  pw.Container(width: 40, child: pw.Text(player['total_run'].toString())),
                                  pw.Container(width: 40, child: pw.Text(player['total_ball'].toString())),
                                  pw.Container(width: 40, child: pw.Text(player['current_match_four'].toString())),
                                  pw.Container(width: 40, child: pw.Text(player['current_match_six'].toString())),
                                  pw.Container(width: 40, child: pw.Text(player['current_match_strike_rate'].toString())),
                                ],
                              ),
                            ),
                          pw.Container(
                            ...
                            child: pw.Row(
                              mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                              children: [
                                pw.Container(width: 100, child: pw.Text('Bowler')),
                          ...
                          for (var player in data['players'].where((p) => p['player_type'] == 'Baller'))
                            pw.Container(
                              color: PdfColors.grey200,
                              child: pw.Row(
                                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                children: [
                                  pw.Container(width: 100, child: pw.Text(player['player_name'])),
                                  pw.Container(width: 40, child: pw.Text(player['current_match_over'].toString())),
                                  pw.Container(width: 40, child: pw.Text(player['current_match_maidan_over'].toString())),
                                  pw.Container(width: 40, child: pw.Text(player['current_match_run'].toString())),
                                  pw.Container(width: 40, child: pw.Text(player['current_match_wicket'].toString())),
                                  pw.Container(width: 40, child: pw.Text(player['current_match_economy_rate'].toString())),
                                ],
                              ),
                            ),
                        ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${widget.team1} v/s ${widget.team2}", style: GoogleFonts.getFont('Poppins')),
            ...
            onPressed: () async {
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: const Text('Do you want to download the scoreboard details as a PDF?'),
                  actions: [
                    TextButton(
                      onPressed: () {
