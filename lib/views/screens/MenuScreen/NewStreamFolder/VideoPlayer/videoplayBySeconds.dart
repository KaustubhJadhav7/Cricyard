...
class VideoCreatorWidget4 extends StatefulWidget {
  @override
  _VideoCreatorWidget4State createState() => _VideoCreatorWidget4State();
}

class _VideoCreatorWidget4State extends State<VideoCreatorWidget4> {
  ...
  Timer? _fetchTimer;
  final int maxFramesToBuffer = 10;
  ...
  Future<void> createNextVideoSegment() async {
    ...
    final String ffmpegCommand =
        '-framerate 7 -i $framesDir/frame_%d.jpg -c:v mpeg4 -q:v 5 -vf "fps=7" $segmentPath';
