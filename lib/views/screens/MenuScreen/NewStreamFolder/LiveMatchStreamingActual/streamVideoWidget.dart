...
class StreamVideoWidget extends StatefulWidget {
  final int matchId;

  StreamVideoWidget({super.key, required this.matchId});

  @override
  _StreamVideoWidgetState createState() => _StreamVideoWidgetState();
}

class _StreamVideoWidgetState extends State<StreamVideoWidget> {
