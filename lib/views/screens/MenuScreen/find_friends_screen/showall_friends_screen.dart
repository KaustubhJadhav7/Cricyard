...
class ShowallFriendsScreen extends StatefulWidget {
  @override
  _ShowallFriendsScreenState createState() => _ShowallFriendsScreenState();
}

class _ShowallFriendsScreenState extends State<ShowallFriendsScreen> {
  ...
  Future<void> _loadFriends() async {
    String? _token = await TokenManager.getToken();
    print("token is : $_token");
    setState(() {
      print("apiservice is getting calling");
      _friendsFuture = _apiService.getAllFriends(_token!);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Color(0xFFC5E1A5), // Light parrot color
                          ...
                          trailing: Row(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () async {
                                  try {
                                    // Call deleteFriendById method when the close icon is tapped
                                    final bool deleted =
                                        await _apiService.deleteFriendById(
                                            friend['id'], _token!);
                                    if (deleted) {
                                      // Friend deleted successfully, update the UI or show a message
